...
import { CertificateAttributes } from './commons.js';
...
export const generateCertificate = ( subject, issuer, validityYears, serialNumber, privateKey, publicKey, privateKeyPasswd ) => {
    const pki = forge.pki
...
export const generateCSR = ( subject, attributes, privateKey, publicKey ) => {
  const pki = forge.pki;
