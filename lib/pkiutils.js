...
import { CertificateAttributes, CsrAttributes, respondTo } from './commons.js';
...
export const generateCertificate = ({ subject, issuer, extensions,
    ...
    if ( !validityYears ) throw new Error('undefined required [ validityYears ] property')
    if ( !serialNumber ) throw new Error('undefined required [ serialNumber ] property')
